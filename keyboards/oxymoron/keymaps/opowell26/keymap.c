...
#define LAYOUT_oxymoron_base( \
    ...
    LAYOUT_wrapper( \
        ...
        LSFT_T(KC_Z), K21, K22, K23, K24, K25, K26, K27, K28, K29, K2A, KC_RSFT, \
        KC_LGUI, KC_LALT, KC_LCTL, LOWER, KC_SPACE, RAISE, KC_RGUI, KC_APP, KC_RCTL \
    )
#define LAYOUT_oxymoron_base_wrapper(...) LAYOUT_oxymoron_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_oxymoron_base_wrapper(
    ...
    [_GAMING] = LAYOUT_oxymoron_base_wrapper(
    ...
    [_MAC] = LAYOUT_oxymoron_base_wrapper(
        _________________QWERTY_L1_________________,           _________________QWERTY_R1_________________,
        _________________QWERTY_L2_________________,           ________________QWERTY_40_R2_______________,
        _________________QWERTY_L3_________________,           _________________QWERTY_R3_________________
    ),
    ...
    [_ADJUST] = LAYOUT_oxymoron_base_wrapper(
