...
#define _________________RAISE_R1__________________   KC_MPLY, ________NUMPAD_R1________, _______
...
#define _________________ADJUST_R3_________________   RGB_MOD, _______, _______, _______, _______
